...
h2 = plot(N_vector, prob_dmpc2,':','Color', green,'Linewidth',2.5);
plot(N_vector, prob_dmpc2,'o','Color', green, 'MarkerFaceColor', green,'Linewidth',1,'markers',10);
...
xlim([3,32])
ylim([0,20])
h1 = plot(N_vector, tmean_traj3,':b','LineWidth', 2.5);
plot(N_vector, tmean_traj3,'ob', 'MarkerFaceColor', 'b','Linewidth',1.5,'markers',10);
h2 = plot(N_vector, tmean_traj2,':','Color', green,'Linewidth',2.5);
plot(N_vector, tmean_traj2,'o','Color', green, 'MarkerFaceColor', green,'Linewidth',1,'markers',10);
h3 = plot(N_vector, tmean_traj,':r','LineWidth', 2.5);
