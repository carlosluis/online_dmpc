...
tbuild_dmpc2 = mean(dmpc2_tbuild, 2);
...
plot(N_vector, tbuild_dmpc2, '--b', 'Linewidth', 2);
xlabel('Number of agents');
ylabel('Computation Time per Agent [ms]');
legend('State CA solve QP', 'State CA build constr', 'Input CA solve QP', 'Input CA build constr')
